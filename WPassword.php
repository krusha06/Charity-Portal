...
<body>
    ...
    <div class="box">
        <div class="login">
            ...
            <br><br>
            <br>
            <form method="POST" action="PasswordC.php">
                <input class="login" type="password" name="pass" placeholder="Enter Password" required/>
                <br><br><br>
                <p style="font-family: RobotoB;float: left;">
                    <a class="login" style="text-decoration: none; " href="ForgotPassword.php">
                    Forgot Password<br>get OTP Now
                    </a>
                </p>
                <p style="float: right;">
