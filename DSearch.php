...
<html>
	...
	<body>
			...
			<a href="DNGOProf.php?id=<?php echo $user;?>">
				<div onmouseover="bigImg(this)" onmouseout="normalImg(this)" style="letter-spacing:1.2px;;border:1px solid black;color:black;float:left;height:47%;font-family:RobotoB;border-radius:8px;padding:15px;width:20%;margin-left:2.5%;margin-right:2.5%;text-align:center;margin-top:2%;">
			...
			<?php
					while($row2 = mysql_fetch_array($retval2, MYSQL_ASSOC)) 
					{
						...
						$con1= $row2['Contact'];
			?>
			<a href="DNGOProf.php?id=<?php echo $user1;?>">
